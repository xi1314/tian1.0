...
@interface WWCameraCutViewController ()

//将根据所定frame来截取图片
//- (UIImage*)WWImageCrop_imageByCropForRect:(CGRect)targetRect;
//- (UIImage *)WWImageCrop_fixOrientation;

@end

@implementation UIImage (WWImageCrop_Addition)
...
@interface WWCameraCutViewController ()<UIScrollViewDelegate>
...
@end
@implementation WWCameraCutViewController
...
//    [self presentViewController:self.minew animated:YES completion:nil];
    ...
    if (self.quedingClickedHandler) {
        self.quedingClickedHandler();
    }
}
