...
#define DefaultSegmentHeight kHeightChange(64)
...
{
    if (scrollView ==(UIScrollView *)[self.view viewWithTag:22])
    {
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset
{
    if (scrollView ==(UIScrollView *)[self.view viewWithTag:22])
    {
        ...
        NSInteger selectIndex = targetX/CGRectGetWidth(scrollView.frame);
